...
def mk_tab_context_menu(callback_object):
    ...
    menu.add(mi_new_tab)
    mi_new_tab_user_shell = Gtk.MenuItem(_("New Tab with User Shell"))
    mi_new_tab_user_shell.connect("activate", callback_object.on_new_tab_with_user_shell)
    menu.add(mi_new_tab_user_shell)
...
def mk_notebook_context_menu(callback_object):
    ...
    menu.add(mi)
    mi = Gtk.MenuItem(_("New Tab with User Shell"))
    mi.connect("activate", callback_object.on_new_tab_with_user_shell)
    menu.add(mi)
